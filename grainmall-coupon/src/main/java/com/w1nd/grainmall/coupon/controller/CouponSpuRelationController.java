...
import com.w1nd.grainmall.coupon.service.CouponSpuRelationService;
...
public class CouponSpuRelationController {
    ...
    public R membercoupons() {
        ...
        couponSpuRelationEntity.setSpuName("满100减10");
        return R.ok().put("coupons",Arrays.asList(couponSpuRelationEntity));
    }
